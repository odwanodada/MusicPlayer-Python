...
#ADD song function
def add_song():
    song = filedialog.askopenfilename(initialdir='/home/user/Downloads/Amapiano/', title="Choose A Song",filetypes=(("mp3 Files", "*.mp3"), ))
...
def add_many_songs():
    song = filedialog.askopenfilename(initialdir='Amapiano/', title="Choose A Song",filetypes=(("mp3 Files", "*.mp3"), ))
...
def play():
    ...
    song = f'/home/user/Downloads/Amapiano/{song}.mp3'
